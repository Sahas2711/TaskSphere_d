...
public class TeamController {
    ...
    public ResponseEntity<Team> addMemberToTeam(@PathVariable Long teamId, @RequestBody String memberEmail) {
        try {
            Team updatedTeam = teamService.addMemberToTeam(teamId, memberEmail);
